Feature: CAMARA Quality On Demand API, 2.0.0-alpha.1 - Operation extendQosSessionDuration
  ...
  Background: Common extendQosSessionDuration setup
    ...
    And the resource "/quality-on-demand/v2alpha1/sessions/{sessionId}/extend"
