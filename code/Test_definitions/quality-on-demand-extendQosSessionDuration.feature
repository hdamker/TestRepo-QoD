Feature: CAMARA Quality On Demand API, 2.2.0-alpha.3 - Operation extendQosSessionDuration
  ...
  Background: Common extendQosSessionDuration setup
    ...
    And the resource "/quality-on-demand/v2alpha3/sessions/{sessionId}/extend"
