Feature: CAMARA Quality On Demand API, 2.2.0-alpha.4 - Operation extendQosSessionDuration
  ...
  Background: Common extendQosSessionDuration setup
    ...
    And the resource "/quality-on-demand/v2alpha4/sessions/{sessionId}/extend"
