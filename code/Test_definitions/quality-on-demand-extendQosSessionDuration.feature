Feature: CAMARA Quality On Demand API, 2.1.0-alpha.2 - Operation extendQosSessionDuration
  ...
  Background: Common extendQosSessionDuration setup
    ...
    And the resource "/quality-on-demand/v2alpha2/sessions/{sessionId}/extend"
