Feature: CAMARA Quality On Demand API, v1.1.0-alpha.2 - Operation extendQosSessionDuration
  ...
  Background: Common extendQosSessionDuration setup
    ...
    And the resource "/quality-on-demand/v1alpha2/sessions/{sessionId}/extend"
