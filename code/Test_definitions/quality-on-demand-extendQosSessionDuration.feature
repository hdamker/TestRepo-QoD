Feature: CAMARA Quality On Demand API, v2.2.0-alpha.5 - Operation extendQosSessionDuration
  ...
  Background: Common extendQosSessionDuration setup
    ...
    And the resource "/quality-on-demand/v2alpha5/sessions/{sessionId}/extend"
