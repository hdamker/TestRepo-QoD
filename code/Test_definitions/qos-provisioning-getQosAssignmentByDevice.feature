Feature: CAMARA QoS Provisioning API, v1.0.0-alpha.3 - Operation getQosAssignmentByDevice
  ...
  Background: Common getQosAssignmentByDevice setup
    ...
    And the resource "/qos-provisioning/v1alpha3/retrieve-qos-assignment"
