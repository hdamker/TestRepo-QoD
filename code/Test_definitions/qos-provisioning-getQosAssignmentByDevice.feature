Feature: CAMARA QoS Provisioning API, v0.3.1-alpha.1 - Operation getQosAssignmentByDevice
  ...
  Background: Common getQosAssignmentByDevice setup
    ...
    And the resource "/qos-provisioning/v0.3alpha1/retrieve-qos-assignment"
