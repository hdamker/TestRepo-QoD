Feature: CAMARA QoS Provisioning API, v1.0.0-alpha.1 - Operation getQosAssignmentByDevice
  ...
  Background: Common getQosAssignmentByDevice setup
    ...
    And the resource "/qos-provisioning/v1alpha1/retrieve-qos-assignment"
