Feature: CAMARA QoS Provisioning API, v0.4.0-alpha.2 - Operation getQosAssignmentByDevice
  ...
  Background: Common getQosAssignmentByDevice setup
    ...
    And the resource "/qos-provisioning/v0.4alpha2/retrieve-qos-assignment"
