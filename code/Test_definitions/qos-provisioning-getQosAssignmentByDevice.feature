Feature: CAMARA QoS Provisioning API, 1.0.0-alpha.2 - Operation getQosAssignmentByDevice
  ...
  Background: Common getQosAssignmentByDevice setup
    ...
    And the resource "/qos-provisioning/v1alpha2/retrieve-qos-assignment"
