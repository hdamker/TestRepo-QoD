Feature: CAMARA QoS Provisioning API, v0.3.1-alpha.1 - Operation getQosAssignmentById
  ...
  Background: Common getQosAssignmentById setup
    ...
    And the resource "/qos-provisioning/v0.3alpha1/qos-assignments/{assignmentId}"
