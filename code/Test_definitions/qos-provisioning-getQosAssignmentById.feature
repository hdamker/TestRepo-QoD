Feature: CAMARA QoS Provisioning API, v1.0.0-alpha.3 - Operation getQosAssignmentById
  ...
  Background: Common getQosAssignmentById setup
    ...
    And the resource "/qos-provisioning/v1alpha3/qos-assignments/{assignmentId}"
