Feature: CAMARA QoS Provisioning API, 1.0.0-alpha.2 - Operation getQosAssignmentById
  ...
  Background: Common getQosAssignmentById setup
    ...
    And the resource "/qos-provisioning/v1alpha2/qos-assignments/{assignmentId}"
