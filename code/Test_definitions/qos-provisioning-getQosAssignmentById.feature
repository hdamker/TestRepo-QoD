Feature: CAMARA QoS Provisioning API, v0.4.0-alpha.2 - Operation getQosAssignmentById
  ...
  Background: Common getQosAssignmentById setup
    ...
    And the resource "/qos-provisioning/v0.4alpha2/qos-assignments/{assignmentId}"
