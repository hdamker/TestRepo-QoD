Feature: CAMARA QoS Provisioning API, v1.0.0-alpha.1 - Operation getQosAssignmentById
  ...
  Background: Common getQosAssignmentById setup
    ...
    And the resource "/qos-provisioning/v1alpha1/qos-assignments/{assignmentId}"
